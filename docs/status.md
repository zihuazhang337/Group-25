...
![](/status_result/Damage_Barroth.png){:height="50%" width="50%"}

![](/status_result/Damage_Tigrex.png){:height="50%" width="50%"}
...
![](/status_result/Final_score_Barroth.png){:height="50%" width="50%"}

![](/status_result/Final_score_Tigrex.png){:height="50%" width="50%"}
