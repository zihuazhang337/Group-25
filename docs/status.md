...
![](/status_result/Damage_Barroth.png) <!-- .element height="50%" width="50%" -->

![](/status_result/Damage_Tigrex.png)
...
![](/status_result/Final_score_Barroth.png)

![](/status_result/Final_score_Tigrex.png)
