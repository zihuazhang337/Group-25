...
![](/status_result/Damage_Barroth.png) {:height="25%" width="25%"}
![](/status_result/Damage_Tigrex.png) {:height="25%" width="25%"}
...
![](/status_result/Final_score_Barroth.png) {:height="25%" width="25%"}
![](/status_result/Final_score_Tigrex.png) {:height="25%" width="25%"}
